...
from TextExtractor import process_and_tokenize_file, TEMP_DOWNLOAD_FOLDER # Importe a função de processamento
...
class DataBaseManager:
    ...
    def process_all_files_recursively(self, folder_id: str) -> dict:
        """Lista todos os arquivos recursivamente, baixa, extrai o texto e tokeniza."""
        ...
        for file_info in all_files:
            ...
            if self.download_file(file_id, file_name, DOWNLOAD_FOLDER):
                ...
                if tokens is not None:
                    processed_data[file_name] = tokens
